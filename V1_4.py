...
class StellarisFormatterApp:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Stellaris 脚本转换工具 v1.4")
    ...
    def _create_button_area(self):
        ...
        self.btn_to_formatted.pack(side="left", expand=True, fill="x", padx=20, pady=10)
        ...
        self.btn_to_compact.pack(side="left", expand=True, fill="x", padx=20, pady=10)
